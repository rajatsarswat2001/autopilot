...
def patch():
    ...
    # Target 1: env1 dict
    old_env = """    "    env1 = {**os.environ,\\n",
    "            'PYTORCH_CUDA_ALLOC_CONF': 'expandable_segments:True',\\n",
    "            'TOKENIZERS_PARALLELISM': 'false',\\n",
    "            'TRANSFORMERS_VERBOSITY': 'error'}\\n","""
    
    new_env = """    "    env1 = {**os.environ,\\n",
    "            'PYTORCH_CUDA_ALLOC_CONF': 'expandable_segments:True',\\n",
    "            'CUDA_VISIBLE_DEVICES': str(video_gpu_id),\\n",
    "            'TOKENIZERS_PARALLELISM': 'false',\\n",
    "            'TRANSFORMERS_VERBOSITY': 'error'}\\n","""
    ...
    if old_env in content and old_wan in content:
        ...
        with open("autopilot_kaggle.ipynb", "w", encoding='utf-8') as f:
            f.write(content)
        print("Notebook patched successfully using string replacement.")
    else:
