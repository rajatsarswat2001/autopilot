...
# ── Cell 6: Fast 15-Second Test Run ───────────────────────────────────────────
cells.append(code_cell(
    "# ── Cell 6: FAST 15-SECOND TEST RUN (Bypasses LLMs) ───────────────────────\n"
    "import os, uuid\n"
    "from orchestration.supervisor import build_pipeline, make_initial_state\n"
    "from langgraph.checkpoint.memory import MemorySaver\n\n"
    "os.environ['AUTOPILOT_AUTO_APPROVE'] = '1'\n"
    "os.environ['VIDEO_GEN_MODEL'] = 'wan22'\n"
    "os.environ['WAN21_I2V_ENABLED'] = '1'\n"
    "os.environ['DISABLE_STOCK'] = '1'\n\n"
    "pre_written_manifest = {\n"
    "    'title': 'Testing AutoPilot Pipeline',\n"
    "    'hook': 'This is a quick 15-second test of the system.',\n"
    "    'scenes': [\n"
    "        {\n"
    "            'scene_id': 1,\n"
    "            'narration': 'This is the first scene. We are testing the speed and quality of the visual generation.',\n"
    "            'visual_prompt_A': 'A cinematic tracking shot of a glowing fiber optic cable inside a dark server room.',\n"
    "            'visual_prompt_B': 'A close up of a glowing microchip on a motherboard.',\n"
    "            'b_roll_keyword_A': 'server',\n"
    "            'b_roll_keyword_B': 'technology',\n"
    "            'emotional_tone': 'neutral',\n"
    "            'niche': 'technology'\n"
    "        },\n"
    "        {\n"
    "            'scene_id': 2,\n"
    "            'narration': 'This is the final scene. If you see this, the pipeline has successfully rendered the video.',\n"
    "            'visual_prompt_A': 'A hyper-realistic sunset over a futuristic cyberpunk city skyline.',\n"
    "            'visual_prompt_B': 'Neon cars driving down a futuristic highway.',\n"
    "            'b_roll_keyword_A': 'cityscape',\n"
    "            'b_roll_keyword_B': 'future',\n"
    ...
    "initial_state = make_initial_state(topic='Testing', niche='technology')\n"
    "initial_state['script_draft'] = 'This is the first scene. We are testing the speed and quality of the visual generation. This is the final scene. If you see this, the pipeline has successfully rendered the video.'\n"
    "initial_state['scene_manifest'] = pre_written_manifest\n"
    "initial_state['uniqueness_score'] = 0.99\n"
    "initial_state['entropy_score'] = 0.99\n"
    "initial_state['compliance_passed'] = True\n\n"
    "print('Injecting test state and skipping to Audio phase...')\n"
    "pipeline.update_state(config, initial_state, as_node='human_review')\n\n"
    "print('Starting execution...')\n"
    "for step in pipeline.stream(None, config=config, stream_mode='updates'):\n"
    "    node_name = list(step.keys())[0]\n"
    "    update = step[node_name]\n"
    "    status = update.get('job_status', 'unknown')\n"
    "    print(f'✅ Completed: {node_name} (Status: {status})')\n"
    "    if update.get('errors'):\n"
    "        for error in update['errors']:\n"
    "            print(f\"❌ ERROR in {error.get('agent')}: {error.get('error')}\")\n\n"
    "final_state = pipeline.get_state(config).values\n"
    "print('\\n' + '='*50)\n"
    "print(f'🎬 TEST COMPLETE')\n"
    "print(f\"Final Video Location: {final_state.get('final_video_path')}\")\n"
    "print('='*50)\n"
))
